...
public class DotBuilder implements GraphBuilder {
    ...
    @Override
    public void buildGraph(VisualGraph graph, PrintWriter out, boolean decorate) {
    ...
    private void buildNode(VisualNode node, PrintWriter out, boolean decorate, Map<VisualNode, String> nodeNames,
            Map<Literal, ColorPair> nodeColors) {
        out.println("# " + node.getClass().getSimpleName() + " " + node.label);
        String name = nodeNames.get(node);
        String label = node.label.replace("\"", "\\\"").replace("<", "&lt;").replace(">", "&gt;");
    ...
    private String buildNodeElement(NodeElement element, String node, String port, PrintWriter out,
            Map<VisualNode, String> nodeNames) {
    ...
    private static final List<ColorPair> colors = Arrays.asList(new ColorPair("#FFC6C6", "#FF0000"),
            new ColorPair("#FFE0C6", "#FF7400"), new ColorPair("#FFECC6", "#FFAA00"),
            new ColorPair("#FFF5C6", "#C5A300"), new ColorPair("#FFFFC6", "#C5C500"),
            new ColorPair("#EAFDC5", "#7BB800"), new ColorPair("#C2FAC2", "#00CC00"),
            new ColorPair("#BEF5F5", "#009999"), new ColorPair("#C6D4F7", "#1240AB"),
            new ColorPair("#D2C6F7", "#3914AF"), new ColorPair("#E4C3F7", "#7109AA"),
