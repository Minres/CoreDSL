 ...
 * </p>
 * <ul>
 *   <li>{@link com.minres.coredsl.coreDsl.impl.ParameterListImpl#getParams <em>Params</em>}</li>
 *   <li>{@link com.minres.coredsl.coreDsl.impl.ParameterListImpl#getParameters <em>Parameters</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterListImpl extends MinimalEObjectImpl.Container implements ParameterList
{
  ...
  {
    return CoreDslPackage.Literals.PARAMETER_LIST;
  }
  ...
  public EList<ParameterDeclaration> getParams()
  {
    if (params == null)
    {
      params = new EObjectContainmentEList<ParameterDeclaration>(ParameterDeclaration.class, this, CoreDslPackage.PARAMETER_LIST__PARAMS);
    }
    return params;
  }
  ...
  public EList<ParameterDeclaration> getParameters()
  {
    if (parameters == null)
    {
      parameters = new EObjectContainmentEList<ParameterDeclaration>(ParameterDeclaration.class, this, CoreDslPackage.PARAMETER_LIST__PARAMETERS);
    }
    return parameters;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case CoreDslPackage.PARAMETER_LIST__PARAMS:
        return ((InternalEList<?>)getParams()).basicRemove(otherEnd, msgs);
      case CoreDslPackage.PARAMETER_LIST__PARAMETERS:
